...
ggplot(avg.all, aes(x = Level, y = Average.Death.Proportion, group = Var)) + 
  ...
  theme_bw() + 
  labs(title = "Main Effects Plot for Total Death Proportion", y = "Average Total Death Proportion", x = "Variable Level") + 
...
ggplot(DeathSummary, 
  ...
  geom_point() + 
  geom_line() +
  facet_grid(HospitalizationRate ~ Beta + InfectionTime, labeller = labeller(Beta = Beta.labs, HospitalizationRate = swr(HospitalizationRate.labs))) +
  # geom_point(aes(color = HospitalizedRecoveryRate)) + 
  theme_bw() + 
  labs(title = "Interaction Plot for Total Death Proportion", 
       y = "Average Total Death Proportion", 
...
ggplot(avg.all, aes(x = Level, y = Average.Infected.Proportion, group = Var)) + 
  ...
  geom_point() + 
  theme_bw() + 
  labs(title = "Main Effects Plot for Total Infected Proportion", y = "Average Total Infected Proportion", x = "Variable Level") +
...
ggplot(InfectedSummary, 
  ...
  theme_bw() + 
  labs(title = "Interaction Plot for Total Infected Proportion", 
       y = "Average Total Infected Proportion", 
       x = "Quarantine")
```
...
ggplot(avg.all, aes(x = Level, y = Average.MaxCaseProportion, group = Var)) + 
  ...
  geom_point() + 
  theme_bw() + 
  labs(title = "Main Effects Plot for Maximum Daily New Case Proportion", y = "Average Maximum Daily New Case Proportion", x = "Variable Level") +
...
ggplot(MaxCaseSummary, 
  ...
  theme_bw() + 
  labs(title = "Interaction Plot for Maximum Daily New Case Proportion", 
       y = "Average Maximum Daily New Case Proportion")
```
...
ggplot(avg.all, aes(x = Level, y = Average.MaxHospitalProportion, group = Var)) + 
  ...
  geom_point() + 
  theme_bw() + 
  labs(title = "Main Effects Plot for Maximum Daily Hospitalization Proportion", y = "Average Maximum Daily Hospitalization Proportion", x = "Variable Level") +
...
ggplot(MaxHospitalSummary, 
  ...
  facet_grid(InfectionTime ~ HospitalizationRate, labeller = labeller(HospitalizationRate = HospitalizationRate.labs)) +
  theme_bw() + 
  labs(title = "Interaction Plot for Maximum Daily Hospitalization Proportion", 
       y = "Average Maximum Daily Hospitalization Proportion")
```

...
result_table <- result_table[-c(16:27)]
```
...
Infected.Anova1 = aov(InfectedProportion ~ Population * Beta * InfectionTime, data = result_table)
...
avg.Beta$Var = "Transmission Rate"
...
avg.all = rbind(avg.Beta, avg.InfectionTime)
# Main Effect Plots
...
InfectedSummary = result_table %>% group_by(Beta, InfectionTime) %>% summarise(Average.Infected.Proportion = mean(InfectedProportion))
# Interaction Plot

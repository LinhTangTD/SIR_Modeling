...
model.data = function(N, beta, I.0, p, epsilon, theta, gamma, TimeH, TimeNH){
  ...
  while(Total.Infective * S > 0 & curr.day < 200){
    curr.day = curr.day + 1
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Hospitalization Rate $\varepsilon$ (3 levels): 5\%, 10\%, and 15\%
        ...
        \item Average days in infected status $\inv{\lambda}$ (2 levels): 1 and 5
    \end{itemize}
\end{itemize}
